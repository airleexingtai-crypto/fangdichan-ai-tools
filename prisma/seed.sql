...
INSERT INTO "Category" ("id", "slug", "name", "description", "icon", "sortOrder") VALUES
...
-- Seed data: Tools
INSERT INTO "Tool" ("id", "slug", "name", "tagline", "websiteUrl", "description", "pricingModel", "pricingJson", "featuresJson", "prosJson", "consJson", "useCasesJson", "foundedYear", "apiAvailable", "avgRating", "reviewCount", "status", "publishedAt", "createdAt", "updatedAt") VALUES
...
-- Tool-Category links
INSERT INTO "ToolCategory" ("toolId", "categoryId", "isPrimary") VALUES
...
-- Tool Alternatives
INSERT INTO "ToolAlternative" ("toolId", "alternativeId") VALUES
('tool-001', 'tool-003'), ('tool-001', 'tool-005'), ('tool-001', 'tool-010'),
('tool-004', 'tool-008'), ('tool-004', 'tool-009'),
('tool-007', 'tool-002');

-- Comparisons
INSERT INTO "Comparison" ("id", "slug", "title", "description", "winnerJson", "status", "publishedAt", "createdAt", "updatedAt") VALUES
...
INSERT INTO "ComparisonTool" ("comparisonId", "toolId") VALUES
('comp-001', 'tool-001'), ('comp-001', 'tool-003'),
('comp-002', 'tool-009'), ('comp-002', 'tool-008'),
('comp-003', 'tool-002'), ('comp-003', 'tool-007');

-- Tutorials
INSERT INTO "Tutorial" ("id", "slug", "title", "description", "estimatedMinutes", "difficulty", "status", "publishedAt", "createdAt", "updatedAt", "categoryId") VALUES
...
INSERT INTO "TutorialTool" ("tutorialId", "toolId") VALUES
('tut-001', 'tool-001'),
('tut-002', 'tool-009'),
('tut-003', 'tool-008');

-- Stat Pages
INSERT INTO "StatPage" ("id", "slug", "title", "heroStat", "heroLabel", "status", "publishedAt", "createdAt", "updatedAt", "categoryId") VALUES
('stat-001', 'ai-adoption-real-estate-2024', 'AI Adoption in Real Estate: 2025 Statistics', '47%', 'of agents now use AI tools', 'PUBLISHED', NOW(), NOW(), NOW(), 'cat-002'),
...
INSERT INTO "StatSource" ("id", "statPageId", "title", "url", "publisher", "year") VALUES
...
-- Reviews
INSERT INTO "Review" ("id", "toolId", "authorName", "rating", "title", "body", "createdAt") VALUES
